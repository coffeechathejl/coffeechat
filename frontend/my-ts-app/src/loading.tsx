...
        </svg>
        ...
        <div style={{width: 568, height: 84, left: 681, top: 655, position: 'absolute', color: '#FFF5E5', fontSize: 64, fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word'}}>brewing coffee</div>
