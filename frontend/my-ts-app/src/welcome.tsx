...
        </svg>
        ...
        <div style={{width: 568, height: 84, left: 681, top: 655, position: 'absolute', color: '#FFF5E5', fontSize: 64, fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word'}}>welcome, NAME</div>
        <div style={{width: 356, height: 55, left: 767, top: 758, position: 'absolute', color: '#FFF5E5', fontSize: 45, fontFamily: 'Inter', fontWeight: '700', textDecoration: 'underline', wordWrap: 'break-word'}}>let’s get started </div>
        <img style={{width: 376, height: 377, left: 755, top: 246, position: 'absolute', borderRadius: 188}} src="https://via.placeholder.com/376x377" />
