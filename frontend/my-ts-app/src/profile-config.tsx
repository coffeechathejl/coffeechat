type ProfileConfigPageProps = {

}
import './welcome.css'
// NO LOADING FUNCTION ATM but can do that if / when I have extra time
// Also may need to quickly change up naming conventions for this file but I do not anticipate major problems
export default function (ProfileConfigPage: ProfileConfigPageProps) {
    return (
...
                </defs>
        </svg>
        <div style={{width: 700, height: 72, left: 153, top: 2, position: 'absolute', color: '#FFF5E5', fontSize: 64, fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word'}}>mocha mentors</div> </div>
        <div style={{width: '100%', height: '100%', position: 'relative', background: '#1E1E1E'}}>
        <div style={{width: 899, height: 156, left: 511, top: 106, position: 'absolute', color: '#FFF5E5', fontSize: 50, fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word'}}>NAME, how do you like your coffee?</div>
        <div style={{width: 975, height: 86, left: 505, top: 258, position: 'absolute', color: '#FFF5E5', fontSize: 50, fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word'}}>What is your gender preference for your match?: Dropbox</div>
        <div style={{width: 1018, height: 86, left: 505, top: 424, position: 'absolute', color: '#FFF5E5', fontSize: 50, fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word'}}>What industry are you interested in?: Dropbox</div>
        <div style={{width: 356, height: 55, left: 830, top: 620, position: 'absolute', color: '#FFF5E5', fontSize: 45, fontFamily: 'Inter', fontWeight: '700', textDecoration: 'underline', wordWrap: 'break-word'}}>let’s brew </div>
        </div>
        </div>
